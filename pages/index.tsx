    ...
    <section>
      ...
      <div className="text-center">
        <h3 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900  lg:text-4xl dark:text-white">Explore by Categories</h3>
          <Link href={`/category/tv`} className="inline-flex items-center px-3 py-1 text-sm font-medium m-3 text-gray-900 bg-gray-200 rounded-full dark:text-white dark:bg-gray-700">
